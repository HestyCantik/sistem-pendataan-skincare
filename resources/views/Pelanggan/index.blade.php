...
<div class="container mt-5">
    ...
    <div class="header-card p-4 mb-4 text-center shadow">
        <h1>👤 Sistem Pendataan Pelanggan</h1>
    ...
    <div class="table-container">
        ...
        <a href="/pelanggan/create" class="btn btn-tambah mb-3">
            ➕ Tambah Pelanggan
        </a>
            ...
            @forelse($data as $index => $item)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="/pelanggan/delete/{{ $item->id }}"
                              method="POST"
...
<script>
document.getElementById('cariPelanggan').addEventListener('keyup', function() {
