...
<head>
    ...
    <title>Data Brand Skincare</title>
...
<div class="container mt-5">
    ...
    <div class="header-card p-4 mb-4 text-center shadow">
        <h1>🏷️ Sistem Pendataan Brand Skincare</h1>
        <p class="mb-0">Kelola data brand skincare dengan mudah</p>
    </div>
    ...
    <div class="table-container">
        ...
        <a href="/brand/create" class="btn btn-tambah mb-3">
            ➕ Tambah Brand
        </a>
            ...
            @forelse($data as $index => $item)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <form action="/brand/delete/{{ $item->id }}"
                              method="POST"
...
<script>
document.getElementById('cariBrand').addEventListener('keyup', function() {
